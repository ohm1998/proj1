...
--
-- Host: localhost
-- Generation Time: May 07, 2019 at 10:39 AM
...
INSERT INTO `admin_details` (`SR`, `NAME`, `USERNAME`, `PASSWORD`, `type`, `mem_id`) VALUES
(2, 'abhimanyu', 'abhi', '123', 'm', 0),
(8, 'Ohm Tejas Trivedi', 'ott', '202cb962ac59075b964b07152d234b70', 'a', 3);
...
(14, 'cat', 20, 'M', 'ABCD', '/uploads/adoption/anim14.jpeg', 0);
...
INSERT INTO `foster` (`id`, `name`, `email`, `contact`, `number`, `address`) VALUES
(1, 'sahil', 'jishanta@gmail.com', '9512885899', 10, 'kjsbakf ksajkfdj asldf'),
(5, 'ohm trivedi', 'ohm.1998@gmail.com', '7016778566', 20, '22563 sjdfks akfd as dfa');
...
(13, '13', 'case 29', '4/5/2019', 'lsnfslandfl', '7016778566', 'ohm trivedi', -1, 'uploads/adoption/anim13.jpeg'),
...
(8, 13, 250, '2019-05-16', 'Finished the finishing', '2019-05-07 08:02:42'),
(9, 13, 200, '-1', 'over', '2019-05-07 08:03:12');
